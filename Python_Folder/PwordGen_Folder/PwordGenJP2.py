...
def makepword():
    ...
    if plength >= 8 and plength <= 32:
        for num in range(pslength):
            charac1 = characters[random.randint(0,clength)]
            charac2 = characters[random.randint(0,45)]
            charac3 = characters[random.randint(46,90)]
            charac4 = characters[random.randint(91,clength)]
